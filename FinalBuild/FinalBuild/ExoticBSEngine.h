...
#include "Random2.h"
/*This is a derived class of ExoticEngine, implementing prices generated following Black-Scholes model.
...
public:
	ExoticBSEngine(const Wrapper<PathDependent>& TheProduct_,
		const Parameters& R_, //interest rate
		const Parameters& D_, //discount rate
		const Parameters& Vol_, //volatilty (sigma)
