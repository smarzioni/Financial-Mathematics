...
//Computes the Implied Volatility starting from the price of a vanilla european call option.
// The stock is supposed to follow the Black-Scholes Method.
//Uses Newton-Raphson Method for roots finding.
