...
#include "..\..\TextBook material\TextBook material\ParkMiller.h"
#include "..\..\TextBook material\TextBook material\ExoticBSEngine.h"
...
int main()
{
	...
	GeometricAsian theOption(times, Expiry, thePayOff);
